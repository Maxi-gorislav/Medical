			...
			<div class="content_scene_cat">
				...
				{else}
                    ...
                    <div class="content_scene_cat_bg">
                        <img src="{*$link->getCatImageLink($category->link_rewrite, $category->id_image, 'category_default')|escape:'html':'UTF-8'*}c/2-category_default/ambulance-stretchers.jpg" 
                             height="{*$categorySize.height*}"   width="100%"
