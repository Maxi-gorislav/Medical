							...
							<div>
								<p class="our_price_display" itemprop="offers" itemscope itemtype="https://schema.org/Offer">{strip}
									...
									{if $priceDisplay >= 0 && $priceDisplay <= 2}
                                                                                  ...
                                                                                  {$rightPrice = {convertPrice price=$productPrice|floatval}}
                                                                                    {if $currencyFormat == 1 || $currencyFormat == 3}
                                                                                             <meta itemprop="priceCurrency" content="{$currency->iso_code}" />    {$currencySign}
                                                                                             <span itemprop="price" class="price" id="our_price_display" content=' {$rightPrice|regex_replace:"/[\\{$currencySign}]/":""}'>
                                                                                                 {$rightPrice|regex_replace:"/[\\{$currencySign}]/":""}
                                                                                             </span>   
                                                                                         {else}
                                                                                             <span itemprop="price" class="price" id="our_price_display">
