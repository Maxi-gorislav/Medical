                            ...
                            {if (!$PS_CATALOG_MODE && ((isset($product.show_price) && $product.show_price) || (isset($product.available_for_order) && $product.available_for_order)))}
                                <div class="content_price" itemprop="offers" itemscope
                                    ...
                                    {if isset($product.show_price) && $product.show_price && !isset($restricted_country_mode)}
                                        ...
                                        {if !$priceDisplay}
                                            {$rightPrice = {convertPrice price=$product.price}}
                                            {if $currencyFormat == 1 || $currencyFormat == 3}
                                                <meta itemprop="priceCurrency" content="{$currency->iso_code}"/>
                                                <span class="price product-price">{$currencySign}</span>
                                                <span itemprop="price" class="price product-price"
                                                      id="our_price_display"
                                                      content='{$rightPrice|regex_replace:"/[\\{$currencySign}]/":""|replace:",":""}'>
                                        ...
                                        {else}
                                            {$rightPrice = {convertPrice price=$product.price_tax_exc}}
                                            {if $currencyFormat == 1 || $currencyFormat == 3}
                                                <meta itemprop="priceCurrency" content="{$currency->iso_code}"/>
                                                <span class="price product-price">{$currencySign}</span>
                                                <span itemprop="price" class="price product-price"
...
{l s='Product available with different options'}
                    ...
                    <div class="right-block product_right">
                        <h5 itemprop="name">
                                ...
                                {if isset($product.show_price) && $product.show_price && !isset($restricted_country_mode)}
                                    ...
                                    {if !$priceDisplay}
                                        ...
                                        {if $currencyFormat == 1 || $currencyFormat == 3}
                                            <meta itemprop="priceCurrency" content="{$currency->iso_code}"/>
                                            <span class="price product-price">{$currencySign}</span>
                                            <span itemprop="price" class="price product-price" id="our_price_display"
                                                  content='{$rightPrice|regex_replace:"/[\\{$currencySign}]/":""|replace:",":""}'>
                                                                                                 {$rightPrice|regex_replace:"/[\\{$currencySign}]/":""}
                                                                                             </span>
                                        {else}
