...
class Supercheckout extends Module
{
    ...
    public function install()
    {
        ...
        if (!parent::install() || !$this->registerHook('displayOrderConfirmation') || !$this->registerHook('displayHeader') || !$this->registerHook('displayAdminOrderContentShip') || !$this->registerHook('displayAdminOrderTabShip') || !$this->registerHook('actionValidateOrder') || !$this->registerHook('displayOrderDetail')) {
            return false;
        }
        ...
        if (Configuration::get('VELOCITY_SUPERCHECKOUT_HEADFOOTHTML')) {
            $data = Tools::unserialize((Configuration::get('VELOCITY_SUPERCHECKOUT_HEADFOOTHTML')));
        ...
        if (Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMBUTTON')) {
            $data = Tools::unserialize((Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMBUTTON')));
        ...
        if (Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMCSS')) {
            $data = Tools::unserialize((Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMCSS')));
            $data = urlencode($data);
        ...
        if (Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMJS')) {
            $data = Tools::unserialize((Configuration::get('VELOCITY_SUPERCHECKOUT_CUSTOMJS')));
            $data = urlencode($data);
    ...
    {
        if (!parent::uninstall() || !Configuration::deleteByName('VELOCITY_SUPERCHECKOUT') || !$this->unregisterHook('displayOrderConfirmation') || !$this->unregisterHook('displayHeader') || !$this->unregisterHook('displayAdminOrderContentShip') || !$this->unregisterHook('displayAdminOrderTabShip') || !$this->unregisterHook('actionValidateOrder') || !$this->unregisterHook('displayOrderDetail')) {
            return false;
        }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit($this->submit_action . $this->name)) {
            ...
            foreach (PaymentModule::getInstalledPaymentModules() as $paymethod) {
                ...
                if ($_FILES['velocity_supercheckout_payment']['size']['payment_method'][$id]['logo']['name'] == 0) {
                    ...
                    if ((($_FILES['velocity_supercheckout_payment']['type']['payment_method'][$id]['logo']['name'] == 'image/jpg') || ($_FILES['velocity_supercheckout_payment']['type']['payment_method'][$id]['logo']['name'] == 'image/jpeg') || ($_FILES['velocity_supercheckout_payment']['type']['payment_method'][$id]['logo']['name'] == 'image/gif') || ($_FILES['velocity_supercheckout_payment']['type']['payment_method'][$id]['logo']['name'] == 'image/png')) && ($_FILES['velocity_supercheckout_payment']['size']['payment_method'][$id]['logo']['name'] < 300000) && in_array($extension, $allowed_exts)) {
                        if ($_FILES['velocity_supercheckout_payment']['error']['payment_method'][$id]['logo']['name'] > 0) {
                            ...
                            if (move_uploaded_file($_FILES['velocity_supercheckout_payment']['tmp_name']['payment_method'][$id]['logo']['name'], _PS_MODULE_DIR_ . 'supercheckout/views/img/admin/uploads/paymethod' . trim($id) . '.' . $extension)) {
            ...
            foreach (Carrier::getCarriers($this->context->language->id, true, false, false, null, Carrier::ALL_CARRIERS) as $deliverymethod) {
                ...
                if ($_FILES['velocity_supercheckout_payment']['size']['delivery_method'][$id]['logo']['name'] == 0) {
                    ...
                    $extension = end($extension);
                    $extension = trim($extension);
                    if ((($_FILES['velocity_supercheckout_payment']['type']['delivery_method'][$id]['logo']['name'] == 'image/jpg') || ($_FILES['velocity_supercheckout_payment']['type']['delivery_method'][$id]['logo']['name'] == 'image/jpeg') || ($_FILES['velocity_supercheckout_payment']['type']['delivery_method'][$id]['logo']['name'] == 'image/gif') || ($_FILES['velocity_supercheckout_payment']['type']['delivery_method'][$id]['logo']['name'] == 'image/png')) && ($_FILES['velocity_supercheckout_payment']['size']['delivery_method'][$id]['logo']['name'] < 300000) && in_array($extension, $allowed_exts)) {
                        if ($_FILES['velocity_supercheckout_payment']['error']['delivery_method'][$id]['logo']['name'] > 0) {
                            ...
                            if (move_uploaded_file($_FILES['velocity_supercheckout_payment']['tmp_name']['delivery_method'][$id]['logo']['name'], _PS_MODULE_DIR_ . 'supercheckout/views/img/admin/uploads/deliverymethod' . trim($id) . '.' . $extension)) {
        ...
        if (Configuration::get('VELOCITY_SUPERCHECKOUT_CSS') || Configuration::get('VELOCITY_SUPERCHECKOUT_CSS') != '') {
            $this->supercheckout_settings['custom_css'] = Tools::unserialize((Configuration::get('VELOCITY_SUPERCHECKOUT_CSS')));
        ...
        if (Configuration::get('VELOCITY_SUPERCHECKOUT_JS') || Configuration::get('VELOCITY_SUPERCHECKOUT_JS') != '') {
            $this->supercheckout_settings['custom_js'] = Tools::unserialize((Configuration::get('VELOCITY_SUPERCHECKOUT_JS')));
        ...
        if (!Configuration::get('VELOCITY_SUPERCHECKOUT_BUTTON') || Configuration::get('VELOCITY_SUPERCHECKOUT_BUTTON') == '') {
            $custombutton = array(
                'button_color' => 'F77219', 'button_border_color' => 'EC6723',
                'button_text_color' => 'F9F9F9', 'border_bottom_color' => 'C52F2F'
            );
        } else {
            $custombutton = Tools::unserialize(Configuration::get('VELOCITY_SUPERCHECKOUT_BUTTON'));
        }
        ...
        if (!Configuration::get('VELOCITY_SUPERCHECKOUT_HFHTML') || Configuration::get('VELOCITY_SUPERCHECKOUT_HFHTML') == '') {
            ...
            $headerfooterhtml = Tools::unserialize(Configuration::get('VELOCITY_SUPERCHECKOUT_HFHTML'));
        }
        ...
        if (!Configuration::get('VELOCITY_SUPERCHECKOUT_EXTRAHTML') || Configuration::get('VELOCITY_SUPERCHECKOUT_EXTRAHTML') == '') {
            ...
            $extrahtml = Tools::unserialize(Configuration::get('VELOCITY_SUPERCHECKOUT_EXTRAHTML'));
        }
    ...
    public function saveTranslation()
    {
        ...
        foreach ($data['velocity_transalator'] as $key => $lang_label) {
            ...
            if (isset($lang_label['label'])) {
                $query = '(' . (int) $language_id . ', \'' . pSQL($language_iso_code) . '\', \'' . pSQL($key) . '_label\', \'' . str_replace("'", "''", pSQL($lang_label['label'][0])) . '\', \'' . str_replace("'", "''", pSQL($lang_label['label'][1])) . '\')';
                Db::getInstance()->execute($ins_query . $query);
            }
            if (isset($lang_label['tooltip'])) {
                $query = '(' . (int) $language_id . ', \'' . pSQL($language_iso_code) . '\', \'' . pSQL($key) . '_tooltip\', \'' . str_replace("'", "''", pSQL($lang_label['tooltip'][0])) . '\', \'' . str_replace("'", "''", pSQL($lang_label['tooltip'][1])) . '\')';
                Db::getInstance()->execute($ins_query . $query);
            }
        }
        ...
        foreach ($data['velocity_transalator'] as $lang_label) {
            ...
            if (isset($lang_label['label'])) {
                ...
                foreach ($template_files as $template) {
                    $language = '$_MODULE[\'<{supercheckout}prestashop>' . $template . '_' . md5($lang_label['label'][0]) . '\'] = \'' . strip_tags(addslashes($lang_label['label'][1])) . '\';';
            ...
            if (isset($lang_label['tooltip'])) {
                ...
                array_push($template_files, 'supercheckout');
                foreach ($template_files as $template) {
                    $language = '$_MODULE[\'<{supercheckout}prestashop>' . $template . '_' . md5($lang_label['tooltip'][0]) . '\'] = \'' . strip_tags(addslashes($lang_label['tooltip'][1])) . '\'; //' . $lang_label['tooltip'][0];
                    fwrite($f, $language . PHP_EOL);
                }
            }
        }
    ...
    public function hookDisplayHeader()
    {
        ...
        if (!Tools::getValue('klarna_supercheckout')) {
            if (isset($settings['super_test_mode']) && $settings['super_test_mode'] != 1) {
                if ($this->context->smarty->tpl_vars['page_name']->value == 'order-opc' || $this->context->smarty->tpl_vars['page_name']->value == 'orderopc' || $this->context->smarty->tpl_vars['page_name']->value == 'order') {
        ...
        if (Configuration::get('VELOCITY_SUPERCHECKOUT_CSS') || Configuration::get('VELOCITY_SUPERCHECKOUT_CSS') != '') {
            $settings['custom_css'] = Tools::unserialize((Configuration::get('VELOCITY_SUPERCHECKOUT_CSS')));
            $settings['custom_css'] = urldecode($settings['custom_css']);
        }

        if (Configuration::get('VELOCITY_SUPERCHECKOUT_JS') || Configuration::get('VELOCITY_SUPERCHECKOUT_JS') != '') {
            $settings['custom_js'] = Tools::unserialize((Configuration::get('VELOCITY_SUPERCHECKOUT_JS')));
