...
<script>
        ...
        {if isset($guest_information) && $guest_information != '' }
            var guest_information = {$guest_information|json_encode};
        {/if}            
	...
	{/if}
        ...
        <div class="supercheckout-column-left columnleftsort" id="columnleft-1" style="width:{$settings['column_width'][$layout_name][1]*$multiplier|escape:'htmlall':'UTF-8'}%"> 
                    ...
                    {if $logged}
                        ...
                        {foreach from=$array_fields item=field}
                            ...
                            <div class="supercheckout-blocks">
                                    {if $field['type']|escape:'htmlall':'UTF-8' eq "textbox"}
                                        <div class="cursor_help" title="{$field['field_help_text']|escape:'htmlall':'UTF-8'}">{$field['field_label']|escape:'htmlall':'UTF-8'}{if $field['required']|escape:'htmlall':'UTF-8' eq "1"}<span style="display:inline;" class="supercheckout-required">*</span>{/if}</div>
                                        <input type="text" name="custom_fields[field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}]" value="{$field['default_value']|escape:'htmlall':'UTF-8'}" class="supercheckout-large-field width_100">
                                        <span id="error_field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}" class="errorsmall_custom hidden_custom"></span>
                                    {/if}

                                    {if $field['type']|escape:'htmlall':'UTF-8' eq "textarea"}
                                        <div class="cursor_help" title="{$field['field_help_text']|escape:'htmlall':'UTF-8'}">{$field['field_label']|escape:'htmlall':'UTF-8'}{if $field['required']|escape:'htmlall':'UTF-8' eq "1"}<span style="display:inline;" class="supercheckout-required">*</span>{/if}</div>
                                        <textarea name="custom_fields[field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}]" class="supercheckout-large-field width_100" style="width: 100%; height: 100px;">{$field['default_value']|escape:'htmlall':'UTF-8'}</textarea>
                                        <span id="error_field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}" class="errorsmall_custom hidden_custom"></span>
                                    {/if}

                                    {if $field['type']|escape:'htmlall':'UTF-8' eq "selectbox"}
                                        <div class="cursor_help" title="{$field['field_help_text']|escape:'htmlall':'UTF-8'}">{$field['field_label']|escape:'htmlall':'UTF-8'}{if $field['required']|escape:'htmlall':'UTF-8' eq "1"}<span style="display:inline;" class="supercheckout-required">*</span>{/if}</div>
                                        <select name="custom_fields[field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}]" class="supercheckout-large-field width_100">
                                        {foreach from=$field['options'] item=field_options}
                                            <option {if $field_options['default_value']|escape:'htmlall':'UTF-8' eq $field_options['option_value']|escape:'htmlall':'UTF-8'}selected{/if} value="{$field_options['option_value']|escape:'htmlall':'UTF-8'}">{$field_options['option_label']|escape:'htmlall':'UTF-8'}</option>
                                        {/foreach}
                                        </select>
                                        <span id="error_field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}" class="errorsmall_custom hidden_custom"></span>
                                    {/if}

                                    {if $field['type']|escape:'htmlall':'UTF-8' eq "radio"}
                                        <div class="cursor_help" title="{$field['field_help_text']|escape:'htmlall':'UTF-8'}">{$field['field_label']|escape:'htmlall':'UTF-8'}{if $field['required']|escape:'htmlall':'UTF-8' eq "1"}<span style="display:inline;" class="supercheckout-required">*</span>{/if}</div>
                                        {assign var=radio_counter value=1}
                                        {foreach from=$field['options'] item=field_options}
                                            <div class="supercheckout-extra-wrap">
                                                <p>
                                                    <div class="radio" id="uniform-field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}"><span>
                                                            <input type="radio" name="custom_fields[field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}]" value="{$field_options['option_value']|escape:'htmlall':'UTF-8'}" {if $field_options['default_value']|escape:'htmlall':'UTF-8' eq $field_options['option_value']|escape:'htmlall':'UTF-8'}checked{/if}>
                                                        </span></div>
                                                    <label for="field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}">{$field_options['option_label']|escape:'htmlall':'UTF-8'}</label>
                                                </p>
                                            </div>
                                    ...
                                    {if $field['type']|escape:'htmlall':'UTF-8' eq "checkbox"}
                                    <div class="cursor_help" title="{$field['field_help_text']|escape:'htmlall':'UTF-8'}">{$field['field_label']|escape:'htmlall':'UTF-8'}{if $field['required']|escape:'htmlall':'UTF-8' eq "1"}<span style="display:inline;" class="supercheckout-required">*</span>{/if}</div>
                                    {foreach from=$field['options'] item=field_options}
                                        <div class="input-box input-field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}">
                                            <div class="checker" id="uniform-field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}">
                                                <span class="checked">
                                                    <input {if $field_options['default_value']|escape:'htmlall':'UTF-8' eq $field_options['option_value']|escape:'htmlall':'UTF-8'}checked{/if} type="checkbox" name="custom_fields[field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}][]" value="{$field_options['option_value']|escape:'htmlall':'UTF-8'}">
                                                </span>
                                            </div>
                                            <label for="field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}"><b>{$field_options['option_label']|escape:'htmlall':'UTF-8'}</b></label>
                                        </div>
                                    {/foreach}
                                    <span id="error_field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}" class="errorsmall_custom hidden_custom"></span>
                                {/if}
            ...
            {*<div class="supercheckout-blocks" data-column="{$settings['design']['shipping_address'][$layout_name]['column']|intval}" data-row="{$settings['design']['shipping_address'][$layout_name]['row']|intval}" data-column-inside="{$settings['design']['shipping_address'][$layout_name]['column-inside']|intval}">
                Custom Field 1:<span style="display:inline;" class="supercheckout-required">*</span>
                <input type="text" name="shipping_address[firstname]" value="" class="supercheckout-large-field">
            </div>*}
		...
		<div class="supercheckout-checkout-content"></div>
                    ...
                    <div class="div_custom_fields">
                    {foreach from=$array_fields item=field}
                        {if $field['position']|escape:'htmlall':'UTF-8' eq 'shipping_address_form'}
                        <div class="supercheckout-blocks">
                            {if $field['type']|escape:'htmlall':'UTF-8' eq "textbox"}
                                <div class="cursor_help" title="{$field['field_help_text']|escape:'htmlall':'UTF-8'}">{$field['field_label']|escape:'htmlall':'UTF-8'}{if $field['required']|escape:'htmlall':'UTF-8' eq "1"}<span style="display:inline;" class="supercheckout-required">*</span>{/if}</div>
                                <input type="text" name="custom_fields[field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}]" value="{$field['default_value']|escape:'htmlall':'UTF-8'}" class="supercheckout-large-field width_100">
            ...
            <div  class="supercheckout-blocks"  data-column="{$settings['design']['payment_address'][$layout_name]['column']|intval}" data-row="{$settings['design']['payment_address'][$layout_name]['row']|intval}" data-column-inside="{$settings['design']['payment_address'][$layout_name]['column-inside']|intval}">
                <div id="checkoutBillingAddress" style="display:{if $settings['use_delivery_for_payment_add'][$user_type]}none{else}block{/if};">
                    ...
                    <div class="div_custom_fields">
                    {foreach from=$array_fields item=field}
                        {if $field['position']|escape:'htmlall':'UTF-8' eq 'payment_address_form'}
                        <div class="supercheckout-blocks">
                            {if $field['type']|escape:'htmlall':'UTF-8' eq "textbox"}
                                <div class="cursor_help" title="{$field['field_help_text']|escape:'htmlall':'UTF-8'}">{$field['field_label']|escape:'htmlall':'UTF-8'}{if $field['required']|escape:'htmlall':'UTF-8' eq "1"}<span style="display:inline;" class="supercheckout-required">*</span>{/if}</div>
                                <input type="text" name="custom_fields[field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}]" value="{$field['default_value']|escape:'htmlall':'UTF-8'}" class="supercheckout-large-field width_100">
			...
			{foreach $products as $product}
                                    ...
                                    <td style="display:{if $logged}{if $settings['cart_options']['product_name']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['cart_options']['product_name']['guest']['display'] eq 1}{else}none{/if}{/if};" class="supercheckout-name">
                                        ...
                                        <div >
                                            ...
                                            {if $image_display eq 1}
                                                <img width='{$settings['cart_image_size']['width']|escape:"html":"UTF-8"}' height='{$settings['cart_image_size']['height']|escape:"html":"UTF-8"}' src='{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:"html":"UTF-8"}' alt='{$product.name|escape:"html":"UTF-8"}' />
						<br>
					<a href="{$link->getProductLink($product.id_product, $product.link_rewrite, $product.category, null, null, $product.id_shop, $product.id_product_attribute)|escape:'html':'UTF-8'}">{$product.name|escape:'html':'UTF-8'}</a>
						...
						<a data-toggle="popover" data-title="{$product.name|escape:'html':'UTF-8'}" data-content="<img width='{$settings['cart_image_size']['width']|escape:"html":"UTF-8"}' height='{$settings['cart_image_size']['height']|escape:"html":"UTF-8"}' src='{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:"html":"UTF-8"}' alt='{$product.name|escape:"html":"UTF-8"}' />" data-placement="right" href="{$link->getProductLink($product.id_product, $product.link_rewrite, $product.category, null, null, $product.id_shop, $product.id_product_attribute)|escape:'html':'UTF-8'}">{$product.name|escape:'html':'UTF-8'}</a>
                                            ...
                                            {/if}
                                            {if isset($product.instructions) && $product.instructions}<br />
                                            &nbsp;<small><a href="{$product_link}">{$product.instructions|escape:'htmlspecialchars':'UTF-8'}</a></small>{/if}
                                        </div>
                                    </td>
					...
					<input size="2" class="quantitybox" autocomplete="off" type="text" name="quantity_{$product.id_product|intval}_{$product.id_product_attribute|intval}_{if $quantityDisplayed > 0}nocustom{else}0{/if}_{$product.id_address_delivery|intval}" value="{if $quantityDisplayed == 0 AND isset($customizedDatas.$productId.$productAttributeId)}{$customizedDatas.$productId.$productAttributeId|@count}{else}{$product.cart_quantity-$quantityDisplayed|intval}{/if}" ><br>
						...
						{/if}
						    ...
						    {if isset($settings['qty_update_option']) && $settings['qty_update_option'] eq 0 }
							    <div>   <a href="javascript:void(0)" class="cart_quantity_down qty-btn" onclick="upQty('quantity_{$product.id_product|intval}_{$product.id_product_attribute|intval}_{$id_customization|intval}_{$product.id_address_delivery|intval}')"><span class="plus-span">+</span></a></div>
                                                {if $logged}
						...
						<div><a href="javascript:void(0)" class="cart_quantity_down qty-btn" onclick="downQty('quantity_{$product.id_product|intval}_{$product.id_product_attribute|intval}_{$id_customization|intval}_{$product.id_address_delivery|intval}')" ><span class="minus-span">-</span></a></div>
								{else}
			    ...
			    {/if}
                            <tr style="display:{if $logged}{if $settings['order_total_option']['total']['logged']['display'] eq 1}{else}none{/if}{else}{if $settings['order_total_option']['total']['guest']['display'] eq 1}{else}none{/if}{/if};">
                                {if $use_taxes}
                                    ...
                                    <td class="value">
					<input type="hidden" id="total_price_wfee" value="{$total_price|escape:'htmlall':'UTF-8'}" >
                                ...
                                {else}
                                    ...
                                    <td class="value"><span id="total_price_without_tax" class="price">{displayPrice price=$total_price_without_tax}</span><input type="hidden" id="total_price_wfee" value="{$total_price_without_tax|escape:'htmlall':'UTF-8'}" ></td>
                                {/if}                                
                            </tr>
                        </tbody>
                    </table>
							...
							{if $displayVouchers}
								...
								<div id="display_cart_vouchers">
									{foreach $displayVouchers as $voucher}
										{if $voucher.code != ''}<span onclick="$('#discount_name').val('{$voucher.code|escape:'html':'UTF-8'}');return false;" class="voucher_name" data-code="{$voucher.code|escape:'html':'UTF-8'}">{$voucher.code|escape:'html':'UTF-8'}</span> - {/if}{$voucher.name|escape:'htmlall':'UTF-8'}<br />
									{/foreach}
								</div>
							{/if}
						</div>
		<div id="loyalty_text_holder">
			{$HOOK_SHOPPING_CART}{*Variable contains html content, escape not required*}
                ...
                <div class="div_custom_fields">
                {foreach from=$array_fields item=field}
                    {if $field['position']|escape:'htmlall':'UTF-8' eq 'cart_block'}
                    <div class="supercheckout-blocks">
                            {if $field['type']|escape:'htmlall':'UTF-8' eq "textbox"}
                                <div class="cursor_help" title="{$field['field_help_text']|escape:'htmlall':'UTF-8'}">{$field['field_label']|escape:'htmlall':'UTF-8'}{if $field['required']|escape:'htmlall':'UTF-8' eq "1"}<span style="display:inline;" class="supercheckout-required">*</span>{/if}</div>
                                <input type="text" name="custom_fields[field_{$field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}]" value="{$field['default_value']|escape:'htmlall':'UTF-8'}" class="supercheckout-large-field width_100">
...
<script>
	...
	$(document).ready(function() {
		...
		{/if}
		$('#{$iso_code|escape:'htmlall':'UTF-8'}_content').show();
	});
