    ...
    <div class="form-horizontal">
        ...
        {if $empty eq 0}
            ...
            {foreach from=$fields_data item=field_data}
                <div class="col-lg-9">
                    <div class="col-lg-3">
                        <p class="form-control-static" style="font-weight: bold;">{l s={$field_data['field_label']|escape:'htmlall':'UTF-8'} mod='supercheckout'}:</p>
                    </div>
                    <div class="col-lg-6">
                        <p class="form-control-static">{$field_data['field_value']|escape:'htmlall':'UTF-8'}</p>
                    </div>
                </div>
            {/foreach}
        {else}
