...
<script type="text/javascript">
    ...
    var pleaseProvideInValidFormat = "{l s='Please provide value(s) in valid format.  (valid format is: value|Label)' mod='supercheckout'}";
                            ...
                            <div class="slimScrollDiv">
                                <div class="slim-scroll">
                                    <ul>
                                        ...
                                        <li class="{if $ps_version eq 15}vss-tab-ver15{/if}"><a class="glyphicons bookmark" target="_blank" href="http://addons.prestashop.com/en/2_community-developer?contributor=38002" target="_blank"><i></i><span>{l s='Other Plugins' mod='supercheckout'}</span></a></li>
                                    </ul>
                                                                    ...
                                                                    <div class="span" style="padding:20px;">
                                                                        <div>
                                                                            ...
                                                                            <div style="float:left;width: 400px;border-radius: 3px;margin-left: 10px;border: 1px solid #E2E2E2;padding: 5px;">
                                                                                <input type="text" value="{$module_url|escape:'htmlall':'UTF-8'}" id="testurlfield">
                                                                            </div> 
                                                                            <div style="
                                                                                 float: left;
                                                                                 margin-left: 10px;
                                                                                 "><input type="button" data-clipboard-action="copy" data-clipboard-target="#testurlfield" value="Copy" class="testurlbutton btn" style="
                                                                                     width: 100px;
                                                                                     color: #FFFFFF;
                                                                                     font-weight: bold;
                                                                                     background: #2EACCE;
                                                        ...
                                                        <div class="block">
                                                            <table class="form">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="settings">
                                                                        <input type="text" class="text-width" name="velocity_supercheckout[fb_login][app_id]" id="velocity_supercheckout_fb_app_id" value="{$velocity_supercheckout['fb_login']['app_id']|escape:'htmlall':'UTF-8'}"/>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="settings" >
                                                                        <input type="text" class="text-width" name="velocity_supercheckout[fb_login][app_secret]" id="velocity_supercheckout_fb_app_secret" value="{$velocity_supercheckout['fb_login']['app_secret']|escape:'htmlall':'UTF-8'}"/>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="settings">
                                                                        <input type="text" class="text-width" name="velocity_supercheckout[google_login][client_id]" id="velocity_supercheckout_ggl_client_id" value="{$velocity_supercheckout['google_login']['client_id']|escape:'htmlall':'UTF-8'}"/>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="settings">
                                                                        <input type="text" class="text-width" name="velocity_supercheckout[google_login][app_secret]" id="velocity_supercheckout_ggl_app_secret" value="{$velocity_supercheckout['google_login']['app_secret']|escape:'htmlall':'UTF-8'}"/>
                                                            ...
                                                            <table class="form">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="settings">
                                                                        ...
                                                                        <span style="width: 9%; display: inline-block;"><input type="button" style="padding: 7.2px 12px;" value="Get Lists" onclick="getMailChimpList()" id="mailchimp_listbtn" class="btn">
                                                                        </span>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="settings"><div>
                                                                                ...
                                                                                <div style="margin-top: 10px;display:flex;padding-left: 10px;">
                                                                                    ...
                                                                                    <span style="padding: 5px 10px 0px 10px;">{l s='Height' mod='supercheckout'}</span>		<div class="input-group" style="width: 40%;"><div style="float: left; width: 100%;"><input type="text" style="width: 90%" class="form-control" id="velocity_supercheckout_payment_method_logo_height_{$pay_methods['id_module']|intval}" name="velocity_supercheckout_payment[payment_method][{$pay_methods['id_module']|intval}][logo][resolution][height]" value="{if isset($velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['resolution']['height'])}{$velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['logo']['resolution']['height']|escape:'htmlall':'UTF-8'}{else}auto{/if}"/><span class="input-group-addon" style="width: 10%; float: left; padding: 8.4px 0;">{l s='px' mod='supercheckout'}</span></div><span id="payment_method_logo_height_error_{$pay_methods['id_module']|intval}" class="supercheckout_error"></span></div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="settings"><div>
                                                                                ...
                                                                                <div style="margin-top: 10px;display:flex;padding-left: 10px;">
                                                                                    ...
                                                                                    <span style="padding: 5px 10px 0px 10px;">{l s='Height' mod='supercheckout'}</span><div class="input-group" style="width: 40%;"><div style="float: left; width: 100%;"><input type="text" style="width: 90%" class="form-control" id="velocity_supercheckout_delivery_method_logo_height_{$carrier['id_carrier']|intval}" name="velocity_supercheckout_payment[delivery_method][{$carrier['id_carrier']|intval}][logo][resolution][height]" value="{if isset($velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['resolution']['height'])}{$velocity_supercheckout_payment['delivery_method'][{$carrier['id_carrier']|intval}]['logo']['resolution']['height']|escape:'htmlall':'UTF-8'}{else}auto{/if}"/><span class="input-group-addon" style="width: 10%; float: left; padding: 8.4px 0;">{l s='px' mod='supercheckout'}</span></div><span id="delivery_method_logo_height_error_{$carrier['id_carrier']|intval}" class="supercheckout_error"></span></div>
                                                                                </div><p class="help-block" style='padding-left: 10px;'> {l s='(To maintain aspect ratio of image, keep either both height and width value as auto or any of them value as auto)' mod='supercheckout'}</p>
                                                                            </td>
                                                                        </tr>
                                                                            ...
                                                                            <tbody id="custom_table_tbody">
                                                                                        ...
                                                                                        <div class="span">
                                                                                            <span class='float_left margin_right_20'>
                                                                                                {foreach $languages as $language}
                                                                                                    <input class="required_entry supercheckout_field_label {if $language_current|escape:'htmlall':'UTF-8' neq $language['id_lang']|escape:'htmlall':'UTF-8'}hidden_custom{/if}" type="text" id='field_label_language_{$language['id_lang']|escape:'htmlall':'UTF-8'}' name="custom_fields[field_label][{$language['id_lang']|escape:'htmlall':'UTF-8'}]">
                                                                                                {/foreach}
                                                                                            </span>
                                                                                ...
                                                                                <tr class="supercheckout_custom_field_form_fields">
                                                                                    ...
                                                                                    <td class="supercheckout_popup_form_field">
                                                                                        <div class="span">
                                                                                            <span class='float_left margin_right_20'>
                                                                                                {foreach $languages as $language}
                                                                                                    <input class="supercheckout_help_text {if $language_current|escape:'htmlall':'UTF-8' neq $language['id_lang']|escape:'htmlall':'UTF-8'}hidden_custom{/if}" type="text" id='help_text_language_{$language['id_lang']|escape:'htmlall':'UTF-8'}' name="custom_fields[help_text][{$language['id_lang']|escape:'htmlall':'UTF-8'}]">
                                                                                                {/foreach}
                                                                                            </span>
                                                                                            <span class='float_left'>
                                                                                ...
                                                                                <tr class="supercheckout_custom_field_form_fields hidden_custom" id="field_options">
                                                                                    ...
                                                                                    <td class="supercheckout_popup_form_field">
                                                                                        <div class="span">
                                                                                            <span class='float_left margin_right_20'>
                                                                                                {foreach $languages as $language}
                                                                                                    <textarea class="supercheckout_field_options {if $language_current|escape:'htmlall':'UTF-8' neq $language['id_lang']|escape:'htmlall':'UTF-8'}hidden_custom{/if}" id='field_options_language_{$language['id_lang']|escape:'htmlall':'UTF-8'}' name="custom_fields[field_options][{$language['id_lang']|escape:'htmlall':'UTF-8'}]"></textarea>
                                                                                                {/foreach}
                                                                                            </span>
                                                                                            <span class='float_left'>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="right"><span class="control-label"><span class="required">*</span>{l s='Position' mod='supercheckout'}</span>
                                                                                        <i class="icon-question-sign tooltip_color" data-toggle="tooltip" data-placement="top" data-original-title="Position of custom input field where it will be displayed."></i>
                                                                                    </td>
                                                                                    <td class="supercheckout_popup_form_field">
                                                                                        <div class="span5">
                                                                                ...
                                                                                <tr class="supercheckout_custom_field_form_fields">
                                                                                    <td class="right"><span class="control-label">{l s='Default Value (optional)' mod='supercheckout'}</span>
                                                                                        <i class="icon-question-sign tooltip_color" data-toggle="tooltip" data-placement="top" data-original-title="Default value of the custom input field."></i>
                                                                                        <p class="help-block">{l s='For selectbox, radio or checkboxes, set the default value like this. Option:- n|No, Default Value:- n' mod='supercheckout'}</p>
                                                                                    </td>
                                                                                    <td class="supercheckout_popup_form_field">
                                                                                        <div class="span">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="right"><span class="control-label"><span class="required">*</span>{l s='Validation Type' mod='supercheckout'}</span>
                                                                                        <i class="icon-question-sign tooltip_color" data-toggle="tooltip" data-placement="top" data-original-title="Type of the validation you want to set for the field."></i>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="right"><span class="control-label">{l s='Required' mod='supercheckout'}</span>
                                                                                        <i class="icon-question-sign tooltip_color" data-toggle="tooltip" data-placement="top" data-original-title="Set field as required or not required."></i>
                                                                                    </td>
                                                                                    <td class="supercheckout_popup_form_field">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="right"><span class="control-label">{l s='Active' mod='supercheckout'}</span>
                                                                                        <i class="icon-question-sign tooltip_color" data-toggle="tooltip" data-placement="top" data-original-title="Set the field as active or inactive."></i>
                                                                                    </td>
                                                                                    <td class="supercheckout_popup_form_field">
                                                                                        <div class="form-group">
                                                                                            <div class="col-lg-9">
...
{*                                                                </form>*}
                                                            ...
                                                            <div class="modal-footer no_border">
                                                                ...
                                                                <button type="button" onclick="submitForm()" class="btn btn-primary">
                                                                    ...
                                                                    <img id='loader_add_form' class='loader_save_button hidden_custom' src='{$module_dir_url}/supercheckout/views/img/admin/ajax_loader.gif'/> {*Variable contains url, escape not required*}
                                                                </button>
                                                            ...
                                                            <table class="table_custom_bordered" id="table_custom_fields_data" style="width: 100%;">
                                                                ...
                                                                <tbody id="tbody_custom_fields_data">
                                                                    ...
                                                                    {foreach from=$custom_fields_details item=array_field}
                                                                        <tr class="pure-table-odd" id="tr_pure_table_{$array_field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'}">
                                                                            <td>{$counter|escape:'htmlall':'UTF-8'}</td>
                                                                            <td class="width_25"><div class="div_250px_ellipsis">{$array_field['field_label']|escape:'htmlall':'UTF-8'}</div></td>
                                                                            <td>{$array_field['type']|escape:'htmlall':'UTF-8'}</td>
                                                                            <td>{$array_field['position']|escape:'htmlall':'UTF-8'}</td>
                                                                            <td>{if $array_field['required']|escape:'htmlall':'UTF-8' eq '1'}{l s='Yes' mod='supercheckout'}{else}{l s='No' mod='supercheckout'}{/if}</td>
                                                                            <td>{if $array_field['active']|escape:'htmlall':'UTF-8' eq '1'}{l s='Yes' mod='supercheckout'}{else}{l s='No' mod='supercheckout'}{/if}</td>
                                                                            <td class="center" style="padding: 12px;">
                                                                                <a style="margin-top: -26px;" href="javascript://" onclick="displayEditCustomFieldPopup({$array_field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'})" type="11" class="velsof-glyphicons2 glyphicons pencil"><i title="{l s='Edit this custom field' mod='supercheckout'}"></i></a>                                                                                                
                                                                                <a style="margin-top: -26px;" href="javascript://" onclick="deleteCustomFieldRow({$array_field['id_velsof_supercheckout_custom_fields']|escape:'htmlall':'UTF-8'})" type="11" class="velsof-glyphicons2 glyphicons bin"><i title="{l s='Delete this custom field' mod='supercheckout'}"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    ...
                                                                    <tr id="tr_custom_fields_add_new">
                                                                        ...
                                                                        <td class="left center">
                                                                            <a style="cursor: pointer; text-decoration: none;" onclick="addNewCustomFieldPopup()" data-toggle="modal">
                                                    ...
                                                    <div class="block">
                                                        ...
                                                        <div class="span3">
                                                            <select {if $ps_version eq 15}class="selectpicker vss_sc_ver15"{/if} name="velocity_supercheckout[layout]" onchange='$.cookie("designTab", 1);
                                                                            location.href = "{$action|escape:'htmlall':'UTF-8'}&velsof_layout=" + $(this).val()'>
                                                                {if $layout eq 1}
                                                                ...
                                                                <div id="tab_lang_misc" class="tab-pane widget-body-regular {if $ps_version eq 15}vss-lang-tab-pane-ver15{/if}">
                                                                    ...
                                                                    <table class="form alternate">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td class="name vertical_top_align"><span>Take advantage of our exclusive offers Text {$label|escape:'htmlall':'UTF-8'}: </span></td>
                                                                                <td class="velsof-english">{if isset($current_lang_translator_vars['front_validation_msg12']['label'][1])}{$current_lang_translator_vars['front_validation_msg12']['label'][1]|escape:'htmlall':'UTF-8'}{else}Take advantage of our exclusive offers{/if}</td>
                                                                                <td class="left">
                                                                                    <input type="hidden" class="translator_input_width" name="velocity_transalator[front_validation_msg12][label][]" value="Take advantage of our exclusive offers" />
                                                                                    <input type="text" class="translator_input_width" name="velocity_transalator[front_validation_msg12][label][]" value="{if isset($selected_lang_translator_vars['front_validation_msg12']['label'][1])}{$selected_lang_translator_vars['front_validation_msg12']['label'][1]|escape:'htmlall':'UTF-8'}{else}Take advantage of our exclusive offers{/if}" />
                                                        ...
                                                        <div class="span faq-span" id="faq-span10">
                                                            <p style="margin-bottom: 0; margin-right: 5px">
                                                                <span class="question" style="font-size: 15px;font-weight: bold; font-size: 15px;">10. Payment method image is not coming?<br><br></span><span class="answer" id="answer10" style="color: black;">
                                                                    ...
                                                                    <br><br>For example: To display Iupay payment module image, you need to add its image in "/modules/iupay/" directory and image name must be iupay. Image extension can be anything and recommended image resolution is 95x20.<br><br> Don't hesistate to contact us if you need any assistance from our side.
                                                                </span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="span faq-span" id="faq-span12">
                                                            <p style="margin-bottom: 0; margin-right: 5px">
                                                                <span class="question" style="font-size: 15px;font-weight: bold; font-size: 15px;">12. In front end when you click login or place order button nothing happens?<br><br></span><span class="answer" id="answer12" style="color: black;">
                                                                    ...
                                                                    <br>In case your issue persists, contact us with your admin and FTP details.
                                                                </span>
                                                            </p>
                                                        </div>
                                                    </div>
...
&lt;div id="LANGISOn_content" style="display: none;"&gt;Your HTML content for the language&lt;/div&gt;
                                                    ...
                                                    <div class="row faq-row" id="14">
                                                        <div class="span faq-span" id="faq-span14">
                                                            <p style="margin-bottom: 0; margin-right: 5px">
                                                            <div class="question" style="font-size: 15px;font-weight: bold; font-size: 15px;">14. Payment method not working and is stuck at 80% after click on place order button.<br><br></div><div class="answer" id="answer14" style="color: black;">
                                                                This happens when your payment method has some unique code and need to be compatible with our module, kindly contact us to get it fixed for free.<br>
                                                            </div>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row faq-row" id="15">
                                                        <div class="span faq-span" id="faq-span15">
                                                            <p style="margin-bottom: 0; margin-right: 5px">
                                                            <div class="question" style="font-size: 15px;font-weight: bold; font-size: 15px;">15.  How to get SEO url like http://www.mysite.com/checkout? .<br><br></div><div class="answer" id="answer15" style="color: black;">
                                                                After installing our module, you need to go to Preferences -> SEO & URLs and create a rule over there to get desired SEO URL.<br>
                                                            </div>
                                                            </p>
                                                        </div>
                                                    </div>
