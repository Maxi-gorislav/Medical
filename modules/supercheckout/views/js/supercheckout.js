...
/**
 * This function accepts element object and id text and accordingly displays different-2 fields for language
 * @param {type} objE
 * @param {type} elementToChange
 * @returns {undefined}
 */
...
/**
 * Thsi functin submits the form if all the values are valid
 * @returns {undefined}
 */
function submitForm()
{
